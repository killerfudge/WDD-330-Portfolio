...
export default class QuakesController {
  ...
  async getQuakesByRadius(radius = 100) {
    /* this method provides the glue between the model and view. Notice it first goes out and requests the appropriate
    data from the model, then it passes it to the view to be rendered.*/
    //set loading message
